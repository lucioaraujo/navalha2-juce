...
inline constexpr std::array tutorialChapters {
    ...
    TutorialChapter {{"2 · LIBRARY", "2 · BIBLIOTECA", "2 · BIBLIOTHÈQUE", "2 · BIBLIOTECA"},
        {"Before starting a project, create a dedicated folder (for example Project_Name/Sources) and place only the material you intend to use there. AUDIO LIBRARY accepts WAV/WAVE and AIFF/AIF audio, and scans the selected folder and its subfolders, up to 512 files; MP3, FLAC, OGG and M4A are not source formats in this version. A clean folder prevents unrelated material from appearing. Use LOAD A/B or drag a file directly to the desired waveform lane.", "Antes de iniciar um projeto, crie uma pasta exclusiva (por exemplo Nome_do_Projeto/Fontes) e coloque nela apenas o material que pretende usar. A BIBLIOTECA DE ÁUDIO aceita WAV/WAVE e AIFF/AIF, e varre a pasta escolhida e suas subpastas, até 512 arquivos; MP3, FLAC, OGG e M4A não são formatos de fonte nesta versão. Uma pasta limpa evita que apareçam materiais sem relação. Use LOAD A/B ou arraste o arquivo para a faixa desejada.", "Avant de commencer un projet, créez un dossier dédié (par exemple Nom_du_Projet/Sources) et placez-y uniquement le matériel prévu. La BIBLIOTHÈQUE AUDIO accepte les fichiers WAV/WAVE et AIFF/AIF, et parcourt le dossier choisi et ses sous-dossiers, jusqu’à 512 fichiers ; MP3, FLAC, OGG et M4A ne sont pas des formats source dans cette version. Un dossier propre évite l’apparition de contenus sans rapport. Utilisez LOAD A/B ou glissez un fichier vers la piste voulue.", "Antes de iniciar un proyecto, cree una carpeta exclusiva (por ejemplo Nombre_del_Proyecto/Fuentes) y coloque allí solo el material que va a usar. La BIBLIOTECA DE AUDIO acepta WAV/WAVE y AIFF/AIF, y examina la carpeta elegida y sus subcarpetas, hasta 512 archivos; MP3, FLAC, OGG y M4A no son formatos de fuente en esta versión. Una carpeta limpia evita que aparezca material ajeno. Use LOAD A/B o arrastre un archivo a la pista deseada."}},
